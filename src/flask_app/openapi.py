...
def build_swagger_ui_html(*, spec_path: str = "/openapi.json") -> str:
    """Render the official Swagger UI shell for the OpenAPI contract."""
    html = """<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
  ...
  <body>
    ...
    <script src="/static/swagger_init.js" data-spec-path="__SPEC_PATH__"></script>
  </body>
</html>
"""
    return html.replace("__SPEC_PATH__", escape(spec_path, quote=True))
